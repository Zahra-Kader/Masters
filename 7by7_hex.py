...
ts_2=h5py.File('/home/zahra/PIPELINE/ex_7by7_hex/draco_synthesis_pt1_gainfluc/maps/tstream_2.h5','r')
ag_2=h5py.File('/home/zahra/PIPELINE/ex_7by7_hex/draco_synthesis_pt1_gainfluc/rand_gains/amp_pt1_phase_pt1/app_gain_2.h5','r')
rg_2=h5py.File('/home/zahra/PIPELINE/ex_7by7_hex/draco_synthesis_pt1_gainfluc/rand_gains/sig_pt12.h5','r')
gn_2=h5py.File('/home/zahra/PIPELINE/ex_7by7_hex/draco_synthesis_pt1_gainfluc/rand_gains/ts_final/app_gain_noise_2.h5','r')
...
#np.save('std_dev_1000runs_gainamp_pt1_initfluc_pt01_hex',gain_std)
gain_std_singrun=np.load('std_dev_1000runs_gainamp_pt1_initfluc_pt01_hex.npy')*np.sqrt(1000) #taking the std deviations from 1000 runs and multiplying by sqrt(1000) to get std dev for one run
